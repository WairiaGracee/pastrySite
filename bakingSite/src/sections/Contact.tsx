...
const contactInfo = [
  { icon: <Phone size={17} className="text-blush" />, label: "Phone", value: "+254 115 435 994", href: "tel:+254700000000" },
  {
    ...
    label: "WhatsApp", value: "+254 115 435 994", href: "https://wa.me/254115435994?text=Hi!%20I'd%20like%20to%20place%20an%20order."
  },
  { icon: <Mail size={17} className="text-blush" />, label: "Email", value: "hello@geepastries.com", href: "mailto:hello@sweetcrumbbakery.com" },
